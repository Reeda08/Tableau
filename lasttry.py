...
output_folder = r"C:\Users\ssing232\OneDrive\OneDrive - JLR\Desktop\Tableau\Reports"
    ...
    if message.UnRead and message.SenderEmailAddress.lower() == sender_email.lower():
        ...
        if attachments.Count > 0:
            for i in range(1, attachments.Count + 1):
                ...
                original_name = re.sub(r'[\\/*?:"<>|]', "_", attachment.FileName)
    ...
    try:
        with pdfplumber.open(pdf_path) as pdf:
            ...
            for line in first_page_text.split('\n'):
                if "SA - " in line.upper():
                    range_value = line.split("-")[-1].strip().upper()
                    break
        print(f"📌 Extracted Range: {range_value}")
    except Exception as e:
        print("❌ Failed to extract range:", str(e))
